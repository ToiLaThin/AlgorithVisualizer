...
/* 
 * Should let all of the search sort engine class inherit from an abstract class which 
 * Mark Del delayByCase so we won't have to reimplement these again for each class and 
 * If we want we can override these in each class -> Polymorphism
 * 
 * With a better design, we would code faster ,debug more effective and it 's also easier to understand and expain
 * 
 * TODO:use thread so as to exit, stop the sort during it
 */
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            switch (cbbSelectAlgo.SelectedItem.ToString())
            {
                ...
                case "QuickSort":
                    ...
                    break;
                case "MergeSort":
                    MergeSortEngine me = new MergeSortEngine();
                    me.Sort(theArray, grapher, pnlScreen.Height, eleWidth);
                    isSorted = true;
                    break;
            }
        }
